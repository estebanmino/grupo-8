...
class PicturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create picture" do
    assert_difference('Picture.count') do
      post pictures_url, params: { picture: { comment: @picture.comment, date: @picture.date } }
    end
  ...
  test "should update picture" do
    patch picture_url(@picture), params: { picture: { comment: @picture.comment, date: @picture.date } }
